						...
						<div class="box-body">
							...
							<div class="form-group text-center">
								...
								<div class="form-group">
									<label>Họ tên</label>
									<input type="text" name="name" class="form-control" required value ="${UserRegister.fullName }">
								</div>
								<div class="form-group">
									<label>Email</label>
									<input type="email" name="email" class="form-control" required value ="${UserRegister.email }">
								</div>
								<div class="form-group">
