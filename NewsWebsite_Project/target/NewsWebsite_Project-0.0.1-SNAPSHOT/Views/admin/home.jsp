    ...
    <div class="row">
      <div class="col-md-12">
        <div class="app-title">
          ...
          <div id="clock"><span class="date"> Thứ Sáu, 18/11/2022 - 21 giờ 24 phút 14 giây</span></div>
        </div>
      </div>
    </div>
    <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="tile">
              ...
              <div class="embed-responsive embed-responsive-16by9">
                <canvas class="embed-responsive-item" id="barChartDemo" width="475" height="267" style="width: 475px; height: 267px;"></canvas>
              </div>
            </div>
          </div>
        </div>
